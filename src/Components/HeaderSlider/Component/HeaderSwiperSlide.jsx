                ...
                <div className='px-3 formbg w-full'>
                    ...
                    >
                        <Form action="" className='md:grid md:grid-cols-4 w-full' >
                            <Field type="text" className='p-3 text w-full ' name='where' placeholder={intl.formatMessage({ id: "whereTo" })} />
                            <Field as="select" className="p-3 w-full " name='destination'>
                                <option selected>{<FormattedMessage id='destination' />}</option>
                                <option value="1">France</option>
                                <option value="2">Cairo</option>
                                <option value="3">Aswan</option>
                            </Field>
                            <Field as='select' className="p-3  w-full" name='duration'>
                            ...
                            <button className='p-3 relative dark:!bg-cyan-900 dark:hover:!bg-slate-900 w-full' type='submit'>
