...
export const RateStarsClick = ({ setFieldValue }) => {
    ...
    for (let i = 0; i < 5; i++) {
        starElements.push(
            <span
                ...
                className={`dark:!text-yellow-500 starHover ${i <= (hoverIndex >= 0 ? hoverIndex : selectedIndex) ? 'starColor' : ''}`}
            >
    ...
    return (
        <div className='flex items-center gap-2 my-3'>
            <span className='dark:!text-white'>{<FormattedMessage id='chooseRate' />} </span>
